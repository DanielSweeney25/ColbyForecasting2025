...
false positive is predicted presence observed background
false negative is predicted background observed presence
...
## Predict with the testing data --- STOPPED HERE IN CLASS 1/22/2025
...
- pretty much identical to what we did today in class
- go through this assignment and re run everything for every month and method (greedy/conservative)
